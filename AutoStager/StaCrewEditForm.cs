...
{
    public partial class StaCrewEditForm : Form
    {
        ...
        {
            con.Open();
            string QUERY = "INSERT INTO StagingCrew" +
        ...
        {
            con.Open();
            string QUERY = "UPDATE StagingCrew SET Name=@Name, Phone=@Phone, Email=@Email, PhoneCarrier=@PhoneCarrier WHERE Id = @Id";
        ...
        {
            con.Open();
            string QUERY = "DELETE FROM StagingCrew WHERE Id = @Id";
        ...
        protected void UpdateDataTable()
        {
            ...
            {
                SqlDataAdapter sda = new SqlDataAdapter("SELECT * FROM StagingCrew", conn);
                {
